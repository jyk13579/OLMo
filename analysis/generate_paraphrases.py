...
input_fname = "fictional_knowledge/fictional_knowledge_paraphrased.json"

dataset = read_json_file(input_fname)

results = []
                   
for idx, data in enumerate(tqdm(dataset[41:])):
    ...
    for i in range(9):
        ...
        if i == 0:
            print('\n')
            print(f"response {idx}/{i}: {response}")
            print('\n\n')
...
with open("fictional_knowledge/fictional_knowledge_paraphrased_results.json", "w") as f:
    json.dump(results, f, indent=4)

import pdb; pdb.set_trace()
temp = [read_json_file('fictional_knowledge/fictional_knowledge_paraphrased_test.json')[-1]]
to_save = dataset[:40] + [read_json_file('fictional_knowledge/fictional_knowledge_paraphrased_test.json')[-1]]+ results

with open("fictional_knowledge/fictional_knowledge_paraphrased_all.json", "w") as f:
